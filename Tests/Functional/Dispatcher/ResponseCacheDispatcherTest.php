 ...
 */
class ResponseCacheDispatcherTest extends AbstractDispatcherTestCase
{
    private const TABLE = 'tx_functionaltest_domain_model_book';

    private const AUTHOR_TABLE = 'tx_functionaltest_domain_model_author';
    ...
    {
        return $this->dispatchGet($url);
    }

    private function dispatchBookItemGet(int $uid): string
    {
        return $this->dispatchGet('https://example.com/_api/books/' . $uid);
    }
}
